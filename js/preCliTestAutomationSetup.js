 ...
 * NOTE: Only ms_root runs the SM agent (neither ms_front nor ms_back has sm.yml).
 * This check is obsolete — all test cases are automated from ms_root regardless of target.
 * Always returns true.
 */
function checkRepoMatch(_ticketKey, _ticket) {
    return true;
}
